...
#Row[1]
Label(UI_frame, text="Size: ", bg='grey').grid(row=1, column=0, padx=5, pady=5, sticky=W) #W == West, so it sticks to left
sizeEntry = Entry(UI_frame)
sizeEntry.grid(row=1, column=1, padx=5, pady=5, sticky=W)

Label(UI_frame, text="Min Value: ", bg='grey').grid(row=1, column=2, padx=5, pady=5, sticky=W) #W == West, so it sticks to left
minEntry = Entry(UI_frame)
minEntry.grid(row=1, column=3, padx=5, pady=5, sticky=W)

Label(UI_frame, text="Max Value: ", bg='grey').grid(row=1, column=4, padx=5, pady=5, sticky=W) #W == West, so it sticks to left
